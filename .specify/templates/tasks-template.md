...
- [ ] T004 [P] Add/update `.env.example` for required configuration keys
...
- [ ] T011 [P] [US1] Happy-path integration or contract test in `tests/`
- [ ] T012 [P] [US1] Edge-case integration or unit test in `tests/`
...
- [ ] T019 [P] [US2] Happy-path integration or contract test in `tests/`
- [ ] T020 [P] [US2] Edge-case integration or unit test in `tests/`
...
- [ ] T025 [P] [US3] Happy-path integration or contract test in `tests/`
- [ ] T026 [P] [US3] Edge-case integration or unit test in `tests/`
...
- [ ] TXXX Run `ruff check .`, `ruff format .`, and `pytest -q`
...
Task: "Happy-path integration or contract test in tests/"
Task: "Edge-case integration or unit test in tests/"
